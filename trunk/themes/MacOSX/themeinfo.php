...
rcs_id('$Id: themeinfo.php,v 1.3 2002-01-03 23:07:43 carstenklapp Exp $');
...
// Sorry, this theme doesn't work yet. :-( There is some more template work
// to do before more of the theme will be committed to the repository.
// --CarstenKlapp
