...
$locale["Otherwise press the \"Back\" button of your browser."] =
   "Anderenfalls ben∏tze die \"Zur∏ck\" Funktion deines Browsers.";
$locale["PhpWiki is unable to save your changes, because another user edited and saved the page while you were editing the page too. If saving proceeded now changes from the previous author would be lost."] =
   "PhpWiki kann deine Veränderungen nicht speichern, da ein andererBen∏tzer die Seite verändert und gespeichert hat, während du diese Seiteeditiert hast. Wenn die Seite jetzt gespeichert werden w∏rde, dann w∏rdendie Veränderungen des anderen Ben∏tzers verloren gehen.";
$locale["Press <b>Save</b> again."] =
   "Dr∏cke nochmal <b>Speichern</b>";
...
$locale["The most recent %s during the past %.1f days are listed below."] =
   "Eine Liste der J∏ngste %s innerhalb von %.1f Tagen.";
$locale["This is a minor change."] =
   "Geringf∏gige Änderung";
...
$locale["Use your browser's <b>Back</b> button to go back to the edit page."] =
   "Ben∏tze die <b>Zur∏ck</b> Funktion deines Browsers um zur Editierseitezu gelangen.";
...
$locale["You entered an invalid login or password."] =
   "Du hast ein ung∏ltiges Login oder Passwort eingegeben.";
$locale["Your careful attention to detail is much appreciated."] =
   "Deine besondere Aufmerksamkeit f∏r Details wird sehr geschätzt.";
$locale["by %s"] =
   "von %s";
$locale["here"] =
   "hier";
