...
$locale["Last edited on %d."] =
   "Zuletzt am %d verändert.";
...
/* LikePages <=> GleicheSeiten */
$locale["LikePages"] =
   "GleicheSeiten";
$locale["List LikePages for [pagename]"] =
   "Zeige die GleicheSeiten für [pagename]";

$locale["Page names with prefix '%s'"] =
   "Page names with prefix «%s»";

$locale["Page names with suffix '%s'"] =
   "Page names with suffix «%s»";
...
/* Lock/Unlock/Administration <=> Sperren/Freigeben/Pflegen */
$locale["Lock page"] =
   "Seite sperren";
...
/* MostPopular <=> MeistBesucht (most visited) */
...
/* RecentChanges <=> FrischeSeiten (fresh pages) */
...
/* SignIn/SignOut <=> Anmelden/Ausmelden */
$locale["SignIn"] =
   "Anmelden";
$locale["SignOut"] =
   "Ausmelden";
