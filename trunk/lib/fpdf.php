...
$GLOBALS['FPDF_font_path'] = dirname(__FILE__)."/fpdf/"; 
...
function FPDF ($orientation='P', $unit='mm', $format='A4')
{
	...
	$this->ws=0;
	//Standard fonts
	$this->CoreFonts=array('japanees'=>'Japanees','courier'=>'Courier','courierB'=>'Courier-Bold','courierI'=>'Courier-Oblique','courierBI'=>'Courier-BoldOblique',
...
{ 
	...
	require_once 'lib/gif.php'; //GIF class in pure PHP from Yamasoft (http://www.yamasoft.com/php-gif.zip)
