...
class FileFinder
{
     ...
     * to PHP's include_path (if it's not already there.)  Then
     * the file is include_once()'d.
     *
     ...
     *
     * The directory is appended only if it is not already listed
     * in the include_path.
     *
     * @access private
 ...
 *
 * This is a subclass of FileFinder which searches a standard list of directories
 * where PEAR code is likely to be installed.
 *
 * Example usage:
 * <pre>
 ...
 * </pre>
 * The above code will look for 'DB.php', if found, the directory in which it was
 * found will be added to PHP's include_path, and the file will be included.
 * (If the file is not found, and E_USER_ERROR will be thrown.)
 */
 ...
 *
 * This is a subclass of FileFinder which searches PHP's include_path for
 * files.  It looks first for "locale/$LANG/$file", then for "$file".
 *
 * If $LANG is something like "de_DE.iso8859-1@euro", this class will
 * also search under various less specific variations like "de_DE.iso8859-1",
 * "de_DE" and "de".
 */
