...
class WikiDB_backend_file extends WikiDB_backend
{
    public $data_dir;
    public $_dir_names;
...
{
    public function __construct($backend, $query_result, $options = array())
    {
