<?php
rcs_id('$Id: AnalyseAccessLog.php,v 1.1 2005-02-02 20:41:02 rurban Exp $');
/*
 ...
 */
class WikiPlugin_AnalyseAccessLog
extends WikiPlugin
{
    /**
     ...
     *
     * FIXME - is there a more correct way to get the name of the accesslog
     * table?
     *
    ...
    function getDefaultArguments() {
        return array(
                     ...
                     // referring_domains, referring_urls, remote_hosts, users, host-users
                     'caption'          => '', 
    ...
    function _getCaption(&$args) {
        ...
        if ($args['period']<>'' && $args['count'])
            $caption = $caption." - ".$args['count']." "._($args['period']);
        return $caption;
    }
