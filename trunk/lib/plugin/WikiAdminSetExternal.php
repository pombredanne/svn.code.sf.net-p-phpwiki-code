...
class WikiPlugin_WikiAdminSetExternal extends WikiPlugin_WikiAdminSelect
{
    ...
    public function run($dbi, $argstr, &$request, $basepage)
    {
        ...
        $buttons = HTML::p(
            Button('submit:admin_external[button]', $button_label, 'wikiadmin'),
            HTML::raw("&nbsp;&nbsp;"),
