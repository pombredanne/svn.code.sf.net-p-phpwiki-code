    ...
    class FPDF
    {
        ...
        function FPDF($orientation = 'P', $unit = 'mm', $format = 'A4')
        {
            ...
            if (is_string($format)) {
                ...
                elseif ($format == 'a4')
                    $format = array(595.28, 841.89); elseif ($format == 'a5')
                    $format = array(420.94, 595.28); elseif ($format == 'letter')
                    $format = array(612, 792); elseif ($format == 'legal')
                    $format = array(612, 1008); else
        ...
        function Image($file, $x, $y, $w = 0, $h = 0, $type = '', $link = '')
        {
            ...
            if (!isset($this->images[$file])) {
                ...
                elseif ($type == 'png')
                    $info = $this->_parsepng($file); elseif ($type == 'gif')
                    $info = $this->_parsegif($file); else {
