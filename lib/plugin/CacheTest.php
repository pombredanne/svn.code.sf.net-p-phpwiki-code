...
{   
    ...
    // if an error occurs you MUST call $this->complain('aboutwhichidocomplain')
    // you may produce an image handle to an error image
    // if you do not, WikiPluginImageCache will do so. 
    ...
    function lazy_produceGraphics( $text, $font ) {
        ...
        return $this->text2img($text,$font,array(0,0,0),array(255,255,255));
